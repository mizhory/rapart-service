...
if ($err) {
	...
	$jsonInput = '[{"method": "6", "PART": "' . $curPage . '", "IDKP": "","IDZayavka": "","StatusZayavka": "",
...
<center>
	...
	<table class="products__block">
		...
		<th class="products__name">Файлы</th>
	</tr>
<?
	foreach( $json as $line ) {
		...
		echo '<td class="product__info">' . $line->State . '</td>';
		echo '<td class="product__info">' . $line->Request . '</td>';
		echo '<td class="product__info">' . $line->Annulirovan . '</td>';
		echo '<td class="product__info">' . $line->File . '</td>';
		echo "</TR>";
