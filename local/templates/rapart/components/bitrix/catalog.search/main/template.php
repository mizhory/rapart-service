...
$GLOBALS['searchFilter'] = array('ACTIVE' => 'Y', '>=CATALOG_QUANTITY' => 1, 'PROPERTY_OPISANIE_NA_RUSSKOM_VALUE' => "%".$_GET['search']."%");
} 
...
if (isset($_GET['q'])){
	$GLOBALS['searchFilter'] = array('ACTIVE' => 'Y', 'NAME' => "%".$_GET['q']."%");
}
    ...
    <nav class="shop-nav">
      <div class="sort shop-nav__item">
        <span class="sort-label">Сортировать по:</span>
			          <button class="sort-btn" onclick="location.href='?sort=alf'">алфавиту</button>
			      </div>
