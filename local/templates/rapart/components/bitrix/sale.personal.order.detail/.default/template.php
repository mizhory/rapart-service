...
<div class="order-num shop">
    <div class="container">
      <div class="order-num__title">
        Заказ №<?=$arResult['ID']?> от <?=$arResult['DATE_INSERT_FORMATED']?>, <?=count($arResult['SHIPMENT']['0']['ITEMS']);?> товар на сумму <?=$arResult['SHIPMENT']['0']['PRICE_DELIVERY_FORMATTED']?>
      </div>
      <div class="order-num__body">
        <!-- Table 1 Информация о Заказе -->
        <div class="order-num__table">
          <div class="order-num__head">Информация о Заказе</div>
          <div class="order-num__wrap order-num__info_wrap">
            <div class="order-num__item">
              <div class="order-num__name">Получатель</div>
              <div class="order-num__info"><b><?=$arResult['USER_NAME']?></b></div>
            </div>
            <div class="order-num__item">
              <div class="order-num__name">Текущий статус</div>
              <div class="order-num__info status-name"><?=$arResult['STATUS']['NAME']?></div>
            </div>
            <div class="order-num__item">
              <div class="order-num__name">Сумма</div>
              <div class="order-num__info">0.00 руб.</div>
            </div>
          </div>
          <span class="order-num__line"></span><?/*
          <div class="order-num__wrap order-num__info_wrap">
            <div class="order-num__item">
                <a class="order-num__document" href="certificate.php">ТКП</a>
            </div>

            <div class="order-num__item">
              <div class="order-num__name">Шкала статуса</div>
              <div class="order-num__scale">
                <span class="scale-status status-active"></span>
                <span class="scale-status status-active"></span>
                <span class="scale-status status-active"></span>
            ...
            <div class="order-num__item">
              <a class="order-num__btn" href="#">Подтвердить</a>
            </div>
          </div>
*/?>
        </div>
        <!-- Table 2 Информация об Оплате -->
        <div class="order-num__table">
          <div class="order-num__head">Информация об Оплате</div>
          <div class="order-num__wrap order-num__diagram_wrap">
<?/*
            <!-- Diagram-circle -->
            <div class="order-num__item order-num__diagram_item">
              <div class="order-num__diagram">
                <svg class="diagram-circle" data-percent="25" data-stroke-color="#232257" width="150" height="150" data-stroke-width="20">
                  <circle cx="50%" cy="50%" r="43%" stroke="#c6c6c6" stroke-width="20" fill="none" />
                  <path class="diagram-circle__arc" fill="none" />
                  <text class="diagram-circle__text" x="50%" y="33" fill="#232257"></text>
                </svg>
              </div>

              <div class="order-num__diagram_info">
                <div class="diagram-avans">
                  <span></span> аванс
                </div> 
                <div class="diagram-rest">
                  <span></span> остаток
                </div> 
              </div>
...
*/?>
            <div class="order-num__item">
              <div class="order-num__item_wrap">
                <div class="order-num__block">
                  <div class="order-num__name">Текущий статус</div>
                  <div class="order-num__info status-name"><?=$arResult['STATUS']['NAME']?></div>
                </div>
                <div class="order-num__block" style="padding-left: 25px;">
                  <div class="order-num__name">Остаток</div>
                  <div class="order-num__info red">0.00 руб.</div>
                </div>
              </div>
<?/*
              <div class="order-num__item_wrap document-block">
                <a class="order-num__document" href="#">Счет на оплату</a>
                <a class="order-num__document" href="#">Товарная накладная</a>
                <a class="order-num__document" href="#">Счет- Фактура</a>
              </div>
*/?>
            </div>
          </div>
...
<?/*
        <!-- Table 3 Информация о Доставке -->
        <div class="order-num__table">
          <div class="order-num__head">Информация о Доставке</div>
          <div class="order-num__wrap">
            <div class="order-num__item">
              <div class="order-num__delivery_img">
                <img src="img/images/delivery.png" alt="" />
              </div>
            </div>
            <div class="order-num__item order-num__delivery_address">
              <div class="order-num__item d-flex">
                <div class="order-num__name order-num__delivery_name">Адрес</div>
                <div class="order-num__info"><?=$arResult['ORDER_PROPS']['11']['VALUE']?></div>
              </div>
              <div class="order-num__item d-flex">
                <div class="order-num__name order-num__delivery_name">Способ доставки</div>
                <div class="order-num__info"><?=$arResult['SHIPMENT']['0']['DELIVERY_NAME']?></div>
              </div>
            </div>
          </div>
        </div>
*/?>
        <!-- Table 4 Содержимое заказа -->
        <div class="order-num__table">
          <div class="order-num__head">Содержимое заказа</div>
          <span class="order-num__line order-num__line_contents"></span>


			  <?foreach ($arResult['SHIPMENT']['0']['ITEMS'] as $order):?>
          <div class="order-num__wrap order-num__contents_wrap">
            <!-- Наименование -->
            <div class="order-num__item">
              <div class="order-num__name">Наименование</div>
              <div class="order-num__info order-num__contents_info d-flex">
                <div class="order-num__contents_img">
                  <img src="img/images/order_img.png" alt="" />
                </div>
                <div class="order-num__contents_text"><b><?=$order['NAME']?></b></div>
              </div>
            </div>
            <!-- Цена -->
            <div class="order-num__item">
              <div class="order-num__name">Цена</div>
              <div class="order-num__info">0.00 руб.</div>
            </div>
            <!-- Количество -->
            <div class="order-num__item">
              <div class="order-num__name">Количество</div>
              <div class="order-num__info"><?=$order['QUANTITY']?> шт.</div>
            </div>
            <!-- Сумма -->
            <div class="order-num__item">
              <div class="order-num__name">Сумма</div>
...
<?endforeach;?>
          ...
          <div class="order-num__wrap order-num__cost_wrap">
            <div class="order-num__item d-flex order-num__cost_item">
              <div class="order-num__name order-num__delivery_name">Стоимость доставки:</div>
              <div class="order-num__info order-num__delivery_price"><b>0.00 руб.</b></div>
            </div>
            <div class="order-num__item d-flex">
              <div class="order-num__name order-num__delivery_name">Итого:</div>
              <div class="order-num__info order-num__delivery_price"><b>0.00 руб.</b></div>
            </div>
          </div>
          <span class="order-num__line line__comment"></span>
<?/*
          <!-- Комментарий -->
          <div class="order-num__wrap">
            <div class="order-num__item order-num__comment_item d-flex"> 
              <div class="order-num__name order-num__comment_name">Комментарий</div>
              <div class="order-num__info order-num__comment_text"><b><?=$arResult['COMMENTS']?></b></div>
            </div>
          </div>
*/?>
        </div>
