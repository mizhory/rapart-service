...
$GLOBALS['arrFilter'] = array('ACTIVE' => 'Y', '>=CATALOG_QUANTITY' => 1);
} 
...
if (isset($_GET['search'])){
	$GLOBALS['arrFilter'] = array('ACTIVE' => 'Y', 'PROPERTY_OPISANIE_NA_RUSSKOM_VALUE' => "%".$_GET['search']."%");
}
