    ...
    <div class="container">
      <div class="account__body">
        <div class="account__item">
			<a href="/en/personal/private/" class="account__link">
            <div class="account__img">
              <i class="account-data"></i>
            </div>
            <h3 class="account__name">Personal data</h3>
          </a>
        </div>
        <div class="account__item">
          <a href="/en/personal/orders/" class="account__link">
            <div class="account__img">
              <i class=" account-order"></i>
            </div>
            <h3 class="account__name">Orders</h3>
          </a>
		  </div><?/*
        <div class="account__item">
          <a href="#" class="account__link">
            ...
            <h3 class="account__name">Current task</h3>
          </a>
        </div>
        <div class="account__item">
          <a href="/en/personal/subscribe/" class="account__link">
            <div class="account__img">
              <i class=" account-subscr"></i>
            </div>
            <h3 class="account__name">Subscriptions</h3>           
          </a>
</div>*/?>
      </div>
    </div>
